...
<div class="container"  style="margin-top: 100px">
    <h3>Edycja oferty kredytu hipotecznego - ${bank.get().bankName}</h3>
    ...
    <form:form method="post" modelAttribute="mortgage">
        ...
        <tr><td>Min okres: </td><td><form:input path="minCreditPeriod" /></td><td><form:errors path="minCreditPeriod" style="color: red" /></td></tr>
